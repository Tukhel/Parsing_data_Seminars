# Работа с API для сбора и обработки данных, а затем создание
# DataFrame для подготовки данных к анализу.
# - Перенести код из блока 3 в Google Colab.
# - Модифицировать код, чтобы извлечь адрес, название
# ресторана, а также координаты (долгота и широта)
...
if response.status_code == 200:
    ...
    print("Запрос не удался. Ошибка - ", response.status_code)